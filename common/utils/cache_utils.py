...
class Cache:
    ...
    __pool = redis.ConnectionPool(host=str(__config.get_value(Consts.CACHE_SECTION, Consts.CACHE_HOST)),
                                  port=int(__config.get_value(Consts.CACHE_SECTION, Consts.CACHE_PORT)),
                                  decode_responses=bool(
                                      __config.get_value(Consts.CACHE_SECTION, Consts.CACHE_DECODE_RESPONSES)))
...
if __name__ == '__main__':
    cache = Cache()
    # print(cache.get('28056489752'))
    # print(cache.mget(*['28056489752', '28045612534']))
    #
    # cache.set(key='test1', value='test_value')
    # cache.set(key='test2', value='test_value', px=10000)
    #
    # map = {'key1': 'value1', "key2": 'value2', "key3": 'value3'}

    # cache.mset(**map)
    # cache.hset('NAMESPACE_TEST', 'test1', 'value')
    # cache.hmset('NAMESPACE_TEST', **map)
    # cache.hdel('NAMESPACE_TEST', *['test1'])
    # print(cache.hexists('NAMESPACE_TEST', 'test1'))
    # print(cache.hget("NAMESPACE_TEST", 'test1'))
    # print(cache.hmget("NAMESPACE_TEST", *['key1', 'test1']))
    # print(cache.hgetall("NAMESPACE_TEST"))

    # cache.ltrim('NAMESPACE_LIST', 0, 0)
    # cache.lpush('NAMESPACE_LIST', *[1, 2, 3, 4, 5, 7, 2, 2])
    # cache.lpush('NAMESPACE_LIST', *[42, 98], left=False)
    # print(cache.lrange('NAMESPACE_LIST', 0, 100))
    # cache.lset('NAMESPACE_LIST', 2, 100)
    # print(cache.lrange('NAMESPACE_LIST', 0, 100))
    # cache.lrem('NAMESPACE_LIST', 100, 2)
    # print(cache.lrange('NAMESPACE_LIST', 0, 100))
    # cache.lpop('NAMESPACE_LIST')
    # print(cache.lrange('NAMESPACE_LIST', 0, 100))
    # print(cache.lindex('NAMESPACE_LIST',2))
    # cache.ltrim('NAMESPACE_LIST',1,2)
    # print(cache.lrange('NAMESPACE_LIST', 0, 100))

    # cache.sadd('NAMESPACE_SET1', *{'aaa', 'bbb', 'ccc', 'eee', 'ddd', 'aaa'})
    # print(cache.smembers('NAMESPACE_SET1'))
    # cache.sadd('NAMESPACE_SET2', *{'bbb', 'eee', 'fff', 'ggg', 'hhh'})
    # print(cache.smembers('NAMESPACE_SET2'))
    # cache.sadd('NAMESPACE_SET3', *{'xxx', 'yyy', 'bbb', 'kkk', 'lll'})
    # print(cache.smembers('NAMESPACE_SET3'))
    # print(cache.sdiff('NAMESPACE_SET1', 'NAMESPACE_SET2', 'NAMESPACE_SET3'))
    # print(cache.sinter('NAMESPACE_SET1', 'NAMESPACE_SET2', 'NAMESPACE_SET3'))
    # print(cache.sunion('NAMESPACE_SET1', 'NAMESPACE_SET2', 'NAMESPACE_SET3'))
    # print(cache.sismember('NAMESPACE_SET1','aaa'))
    # print(cache.smembers('NAMESPACE_SET1'))
    # print(cache.smembers('NAMESPACE_SET2'))
    # cache.smove('NAMESPACE_SET1', 'NAMESPACE_SET2', 'aaa')
    # print(cache.smembers('NAMESPACE_SET1'))
    # print(cache.smembers('NAMESPACE_SET2'))

    # print(cache.smembers('NAMESPACE_SET1'))
    # print(cache.spop('NAMESPACE_SET1'))
    # print(cache.smembers('NAMESPACE_SET1'))

    # print(cache.smembers('NAMESPACE_SET2'))
    # cache.srem('NAMESPACE_SET2', 'eee', 'fff')
    # print(cache.smembers('NAMESPACE_SET2'))

    # print(cache.keys())
    # print(cache.exists('NAMESPACE_SET3'))
    # print(cache.exists('NAMESPACE_SET1'))
    # print(cache.type('NAMESPACE_SET3'))
    # cache.rename('NAMESPACE_SET1', 'NAMESPACE_SET2')
    # print(cache.keys())
    # cache.delete('key1', 'key2', 'key4')
    # print(cache.keys())
    # cache.expire('key3', 5)
    # print(cache.keys())
